...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ObservedPerson.number'
        db.alter_column(u'documents_observedperson', 'number', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ObservedPerson.number'
        db.alter_column(u'documents_observedperson', 'number', self.gf('django.db.models.fields.IntegerField')(default=0))
